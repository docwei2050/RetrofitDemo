...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
  ...
  static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(
   ...
   //创建CallAdapter 区分是走默认的还是Rxjava
    ...
    Type responseType = callAdapter.responseType();//不能是okhttp3的Response哈
    ...
    if (!isKotlinSuspendFunction) {
      //reqeustFactory含有很多请求信息，callFactory创建call的，responseConverter是响应体转换用的，最后一个是适配返回值用的
  ...
  static final class SuspendForBody<ResponseT> extends HttpServiceMethod<ResponseT, Object> {
    ...
    protected Object adapt(Call<ResponseT> call, Object[] args) {
      ...
      try {
        ...
        Object obj=KotlinExtensions.suspendAndThrow(e, continuation);
        return obj;
      }
    }
  }
